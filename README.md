...
- Flow map node boxes at 360px — went 360 → 460 → back to 360 across sessions; current width is the intentional final call, some longer descriptions wrap to 2 lines
